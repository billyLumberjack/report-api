module.exports = class ParamsHelper {
    ...
    static ceaDayOfYear(queryString, params) {
        //Starting Altitude interval
        if (queryString.fromDayOfYear != null || queryString.toDayOfYear != null) {

            if (queryString.fromDayOfYear != null) {
                //from set
                if (queryString.toDayOfYear != null) {
                    //to set
                    params.filter.DayOfYear = { 
                        $gte: parseInt(queryString.fromDayOfYear),
                        $lte: parseInt(queryString.toDayOfYear)
                    };
                } else {
                    //to NOT set
                    params.filter.DayOfYear = { $gte: parseInt(queryString.fromDayOfYear) };
                }
            } else if (queryString.toDayOfYear != null) {
                //from NOT set && to set
                params.filter.DayOfYear = { $lte: parseInt(queryString.toDayOfYear) };
            }
